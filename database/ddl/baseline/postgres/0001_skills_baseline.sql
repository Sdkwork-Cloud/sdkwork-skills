-- SDKWork skills consolidated initialization baseline (postgres)
...
-- baseline source: ddl/baseline/postgres/0001_skills_baseline.sql
...
-- folded migrations retired for greenfield initialization:
--   migrations/postgres/0002_migrate_kernel_a_agent_skill_package.sql
--   migrations/postgres/0003_replace_c_category_with_ai_skill_category.sql
-- Legacy cutover SQL runs only when source tables exist; omitted from greenfield baseline.
